...
const ProductInteraction = ({
  ...
  const handleTypeChange = (type: string, value: string) => {
    // Handle size or color change logic here
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      {/* Buttons */}
      <button
        className="bg-gray-800 text-white px-4 py-2 rounded-md shadlow-lg flex items-center justify-center gap-2 cursor-pointer text-sm font-medium"
